...
const translations = {
    en: {
      ...
      "hero.cta.button": "Costs Less Than One Mistake ",
  ...
  fr: {
      ...
      "hero.cta.button": "Coûte moins qu'une seule erreur ",
  ...
  "about.cta.button": "Obtenez le Guide Travel Readz",
    ...
    // whatsApp support 
      ...
      "pta.finalCta.btn": "Choisissez votre formule — À partir de 12,99 $",
  ...
  "pricing.vip.features.11": "Support voyage en temps réel (éviter arnaques & mauvaises affaires)",
    ...
    es: {
      ...
      "hero.cta.button": "Cuesta menos que un solo error ",
      ...
      "finalCta.subtitle": "Únete a cientos de viajeros que han descubierto Marruecos al estilo local.",
      "finalCta.button": "Elige tu paquete — Desde 12,99 $",
      "finalCta.instant": "✓ Descarga Instantánea",
      "finalCta.secure": "✓ Pago Seguro",
      "finalCta.lifetime": "✓ Acceso de por Vida",
  ...
  "about.cta.button": "Obtén la Guía Travel Readz", 
    ...
    // Navigation
      ...
      "pta.finalCta.btn": "Elige tu paquete — Desde 12,99 $",
